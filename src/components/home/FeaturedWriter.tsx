...
const FeaturedWriter = ({ writerData }: { writerData: Writer[] | null }) => {
  return (
    <div className="flex flex-wrap overflow-auto md:gap-0">
      {writerData &&
        writerData?.map((writer) => (
          <div
            className="flex flex-wrap my-2 gap-4 items-center md:w-[50%] w-full justify-center"
            key={writer.id}
          >
            <div>
            ...
            <div>
              ...
              <div className="text-[#8599A2] text-lg md:text-sm">
